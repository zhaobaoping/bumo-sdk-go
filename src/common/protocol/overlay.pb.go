...
type Hello struct {
	...
	BumoVersion          string   `protobuf:"bytes,4,opt,name=bumo_version,json=bumoVersion" json:"bumo_version,omitempty"`
...
func (m *Hello) GetBumoVersion() string {
	if m != nil {
		return m.BumoVersion
	}
	return ""
}
...
func (m *ChainStatus) GetBumoVersion() string {
	if m != nil {
		return m.BumoVersion
	}
	return ""
