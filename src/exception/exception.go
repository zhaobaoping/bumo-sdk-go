...
const (
	SUCCESS                               int = 0
	KEYPAIR_CREATE_ERROR                  int = 11001
	...
	INVALID_TOADDRESS_ERROR               int = 11038
...
func GetSDKRes(code int) SDKResponse {
	errm := map[int]string{
		SUCCESS:                               "",
		KEYPAIR_CREATE_ERROR:                  "Create keypair failed",
		...
		INVALID_CTP_ERROR:                     "The length of ctp must between 1 and 64",
		...
		INVALID_TOADDRESS_ERROR:               "Invalid toAddress",
